                  ...
                  <div class="row align-items-center">
                      ...
                      <div class="col-xl-6 col-lg-6 col-md-7">
                          <div class="header__action d-flex justify-content-center justify-content-md-end">
                              <ul>
                                  <li>
                                      <a href="{{ route('wishlist') }}"><i class="fal fa-heart "></i> <span
                                              class="cart__total-item wishlist">{{ $wishlist }}</sub></span></a>
                  ...
                  <div class="row align-items-center">
                      <div class="col-xl-4 col-lg-3 col-md-3">
                          <div
                              ...
                              <div class="logo">
                                  <a href="/"><img src="{{ asset('frontend/img/logo/logo-black.png') }}"
                                          alt="logo"></a>
                              </div>
                                      ...
                                      <div class="header__search-cat">
                                          ...
                                          <select onchange="window.location.href=this.options[this.selectedIndex].value;">
                                              @foreach ($cats as $item)
                                                  <option value="{{route('cat.product', $item->id)}}">
                                                      {{ $item->category_name }}
                                                  </option>
                                              @endforeach
                                          </select>
                                      ...
                                      <ul>
                                                  ...
                                                  <div class="cart__inner d-flex">
                                                      <div class="cart__thumb">
                                                          <a href="product-details.html">
                                                              <img src="{{ asset('frontend/img/shop/product/cart/cart-mini-1.jpg') }}"
                                                                  alt="">
                                                          </a>
                                                      </div>
                                          ...
                                          <li>
                                              <a href="checkout.html" class="t-y-btn w-100 mb-10">Proceed to
                                                  checkout</a>
                                              <a href="cart.html" class="t-y-btn t-y-btn-border w-100 mb-10">view add
                                                  edit cart</a>
                                          </li>
                                      </ul>
                                  </div>
                                                    ...
                                                    <li><a href="">{{ $item->category_name }}</a>
                                                        ...
                                                        <ul class="mega-item">
                                                            @foreach ($sub_cats as $data)
                                                                <li><a href="{{route('subcat.product',$data->id )}}">{{ $data->sub_category_name }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    </li>

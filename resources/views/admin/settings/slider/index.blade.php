                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-sm-12">
                                        <a href="{{ route('slider.create') }}" class="btn btn-outline-primary">Add new</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset($item->image) }}" style="width: 80px"
                                                        alt="{{ $item->image }}"></td>
                                                        <td>
                                                            @if ($item->status==1)
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('slider.delete', $item->id) }}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>

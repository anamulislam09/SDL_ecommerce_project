        ...
        <div class="row gx-0">
            <div class="col-xxl-12">
                <div class="about__banner w-img">
                    <img src="{{ asset('frontend/img/about/about-bg.jpg')}}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="team__inner pl-155 pr-155">
            ...
            <div class="row">
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4">
                    <div class="team__item text-center mb-30">
                        <div class="team__thumb w-img fix">
                            <img src="{{ asset('frontend/img/team/as1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4">
                    <div class="team__item text-center mb-30">
                        <div class="team__thumb w-img fix">
                            <img src="{{ asset('frontend/img/team/as2.jpg')}}" alt="">
                        </div>
                        <div class="team__content">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4">
                    <div class="team__item text-center mb-30">
                        <div class="team__thumb w-img fix">
                            <img src="{{ asset('frontend/img/team/as3.jpg')}}" alt="">
                        </div>
                        <div class="team__content">
                            <h3>Salim Rana</h3>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4">
                    <div class="team__item text-center mb-30">
                        <div class="team__thumb w-img fix">
                            <img src="{{ asset('frontend/img/team/as4.jpg')}}" alt="">
                        </div>
                        <div class="team__content">
                            <h3>Pavilion Dyne</h3>

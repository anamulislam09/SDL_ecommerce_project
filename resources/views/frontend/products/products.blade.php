                            ...
                            <ul>
                                <li class="product__sm-item d-flex align-items-center">
                                    <div class="product__sm-thumb mr-20">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/img/shop/product/sm/product-sm-1.jpg')}}" alt="">
                                        </a>
                                    </div>
                                ...
                                <li class="product__sm-item d-flex align-items-center">
                                    <div class="product__sm-thumb mr-20">
                                        <a href="product-details.html">
                                            <img src="{{ asset('frontend/img/shop/product/sm/product-sm-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product__sm-content">
                                        <h3 class="product__sm-title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                         <div class="product__item white-bg mb-30">
                                             <div class="product__thumb p-relative" >
                                                 <a href="product-details.html" class="w-img">
                                                     <img src="{{ asset('frontend/img/shop/product/product-24.jpg')}}" alt="product">
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4">
                                         <div class="product__item white-bg mb-30">
                                             <div class="product__thumb p-relative" >
                                                 <a href="product-details.html" class="w-img">
                                                     <img src="{{ asset('frontend/img/shop/product/product-18.jpg')}}" alt="product">
                                                     <img class="second-img" src="{{ asset('frontend/img/shop/product/product-19.jpg')}}" alt="product">
                                                 </a>
                                                 <div class="product__action p-absolute">
                                                     <ul>
                                                         <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                         ...
                                         <div class="product__item white-bg mb-30">
                                             <div class="product__thumb p-relative" >
                                                 <a href="product-details.html" class="w-img">
                                                     ...
                                                     <img class="second-img" src="{{ asset('frontend/img/shop/product/product-21.jpg')}}" alt="product">
                                                 </a>
                                                 <div class="product__action p-absolute">
                                                     <ul>
                                                         <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
                                         ...
                                         <div class="product__item white-bg mb-30">
                                             <div class="product__thumb p-relative" >
                                                 <a href="product-details.html" class="w-img">
                                                     ...
                                                     <img class="second-img" src="{{ asset('frontend/img/shop/product/product-23.jpg')}}" alt="product">
                                                 </a>
                                                 <div class="product__action p-absolute">
                                                     <ul>
                                                         <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
